  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div
          className="absolute -inset-4 rounded-2xl bg-gradient-to-r from-pink-500/10 via-rose-500/10 to-pink-500/10 blur-2xl pointer-events-none"
          style={{ animation: "glowSnake 4s ease-in-out infinite" }}
        />
        <div
          className="glass-card rounded-2xl shadow-2xl overflow-hidden border border-border/50 relative"
          style={{
